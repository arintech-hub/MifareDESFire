...
import arin.desfirelib.library.param.AID;
import arin.desfirelib.library.security.AuthType;
...
/* Manages the control and update of the different parameters needed during a
 * communication session with a Mifare DESfire card */
...
public class DFSession {
    ...
    /* Stores the parameters of the new authentication status @param newAuthType
     * an instance of class <code>AuthType</code> representing the type of authentication
     * @param authKeyNum an int representing the number of the key to which the 
     * authentication has been achieved @param newSessionKey a byte array containing 
     * the session key generated by means of the authentication procedure
     * @param PICCAuth a boolean indicating whether the card can be trusted or not */
    ...
    /* Updates the identifier of the currently selected application within the card
     * @param aid an instance of class <code>AID</code> representing the currently 
    ...
    /* @return an int representing the number of the key to which the authentication 
     * has been achieved */
    public int getAuthKeyNum(){ return this.authKeyNum; }
	
    /* @return a byte array containing the session key generated by means of the
     * authentication procedure */
    public byte[] getSessionKey(){ return this.sessionKey; }
	
    // @return a boolean indicating whether the card can be trusted or not
    public boolean getPICCAuth(){ return this.PICCAuth; }
		
    /* @return an instance of class <code>AID</code> representing the currently
     * selected application */
    ...
    /* Updates the new initial vector for the computation of the CMAC
     * and indicates whether the previous CMAC check has been successful or not
     * @param newIV a byte array containing the new CMAC initial vector
    ...
    /* Retrieves the current CMAC initial value @return a byte array containing 
     * the current CMAC initial value */
    public byte[] getCmacIV(){ return this.cmacIV; }
	
    /* Retrieves the current CMAC check status @return <code>true</code> if the 
     * previous CMAC check was successful; <code>false</code> otherwise */
