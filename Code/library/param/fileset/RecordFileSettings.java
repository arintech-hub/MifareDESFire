...
public class RecordFileSettings extends FileSettings {
    ...
    /* Creates an instance of class <code>RecordFileSettings</code> @param size 
     * an instance of class <code>Size</code> representing the size of the file
    ...
    /* Creates an instance of class <code>RecordFileSettings</code> @param fileType 
     * an instance of class <code>FileType</code> representing the type of the file
     * @param comSet an instance of class <code>ComSet</code> representing the file's 
     * communication settings @param accessRights an instance of class 
     * <code>AccessRights</code> representing the file's access rights @param size
     * fileSize an instance of class <code>Size</code> representing the size of 
     * the file @param max an int representing the maximum number of records
     * @param current an int representing the current number of records */
	...
	if((size.getSize() < 0) || (size.getSize() > DigitUtils.toInt("FFFFFF"))) 
