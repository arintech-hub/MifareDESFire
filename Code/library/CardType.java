...
/* Provides singleton objects representing some of the contactless card models 
 * of the Mifare family, and allows its identification according to the 
 * obtained ATR */
...
public enum CardType {
    ...
    /* Identifies a Mifare model according to the obtained ATR @param atr the 
     * obtained ATR of the detected contactless card @return a singleton 
     * <code>CardType</code> object representing the model of the detected 
     * card */
