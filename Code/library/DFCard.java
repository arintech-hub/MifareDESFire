...
import arin.desfirelib.library.param.*;
import arin.desfirelib.library.param.fileset.*;
import arin.desfirelib.library.security.*;
import arin.desfirelib.middleware.*;
import arin.desfirelib.utils.ba.*;
import arin.desfirelib.utils.security.*;
...
public class DFCard {
    /* Constructs an instance of class DFCard @param cm a previously connected 
     * ComManager instance */
    ...
    /* Executes the interpreted version of the Authenticate command, as defined 
     * in the Mifare DESFire API. Response only includes the Status Code returned 
     * by the card. @param keyNum the key number within the selected card application
     * with which we want to authenticate @param key an instance of class 
     * <code>DFKey</code> containing the data about the key identified by 
     * <code>keyNum</code> @return an instance of class <code>DFResponse</code> 
     ...
     * in the Mifare DESFire API. Response only includes the Status Code returned 
     * by the card. @param keyNum the key number within the selected card application
     * with which we want to authenticate @param keyData a byte array containing 
     * the key identified by <code>keyNum</code> @return an instance of class 
    ...
    /* Executes the raw version of the Authenticate command, as defined in the 
     * Mifare DESFire API. @param keyNum a byte array representing the key number 
     * within the selected card application with which we want to authenticate
     * @param keyData a byte array containing the key identified by <code>keyNum</code>
     * @return a byte array representing the response obtained from the Mifare DESFire 
    ...
    /* Executes the interpreted version of the Authenticate ISO command, as defined 
     * in the Mifare DESFire EV1 API. Response only includes the Status Code returned 
     * by the card. @param keyNum the key number within the selected card application
     * with which we want to authenticate @param key an instance of class 
     * <code>DFKey</code> containing the data about the key identified by <code>keyNum</code>
    ...
    /* Executes the raw version of the Authenticate ISO command, as defined in 
     * the Mifare DESFire EV1 API. Response only includes the Status Code returned 
     * by the card. @param keyNum a byte array representing the key number within 
     * the selected card application with which we want to authenticate @param keyData 
     * a byte array containing the key identified by <code>keyNum</code>
    ...
    /* Executes the interpreted version of the Authenticate AES command, as defined
     * in the Mifare DESFire EV1 API. Response only includes the Status Code returned 
     * by the card. @param keyNum the key number within the selected card application
     * with which we want to authenticate. Response only includes the Status Code 
     * returned by the card. @param key an instance of class <code>DFKey</code> 
     * containing the data about the key identified by <code>keyNum</code>
     * @return an instance of class <code>DFResponse</code> containing the response 
     * obtained from the Mifare DESFire card to the transmitted command */
     ...
     * by the card. @param keyNum the key number within the selected card application
     * with which we want to authenticate. Response only includes the Status Code 
     * returned by the card. @param keyData a byte array containing the key identified 
     * by <code>keyNum</code> @return an instance of class <code>DFResponse</code> 
     * containing the response obtained from the Mifare DESFire card to the transmitted command */
    ...
    /* Executes the raw version of the Authenticate ISO command, as defined in the 
     * Mifare DESFire EV1 API. Response only includes the Status Code returned by 
     * the card. @param keyNum a byte array representing the key number within the 
     * selected card application with which we want to authenticate @param keyData 
     * a byte array containing the key identified by <code>keyNum</code>
     * @return a byte array representing the response obtained from the Mifare DESFire 
     * card to the transmitted command */
     ...
     * returned by the card. @param ks an instance of class <code>KeySettings</code> 
     * representing the new key settings of the currently selected card application
     * @return an instance of class <code>DFResponse</code> containing the response 
     * obtained from the Mifare DESFire card to the transmitted command */
    ...
    /* Executes the raw version of the Change Key Settings command, as defined in 
     * the Mifare DESFire API. @param cipKeySettings a byte array containing the 
     * new key settings of the currently selected card application, transformed
    ...
    /* Executes the interpreted version of the Set Configuration command, as defined 
     * in the Mifare DESFire EV1 API. Response only includes the Status Code returned 
     * by the card. @param opt an instance of class <code>ConfigOption</code>
     * including the configuration option to be set in the card and the corresponding 
     * data @return an instance of class <code>DFResponse</code> containing the response 
     * obtained from the Mifare DESFire card to the transmitted command */
    ...
    /* Executes the raw version of the Set Configuration command, as defined in 
     * the Mifare DESFire EV1 API. @param opt a byte array representing the 
     * configuration option to be set in the card @param encData a byte array 
     * representing the data to be set in the card, transformed for security as 
     * required @return a byte array representing the response obtained from the 
    ...
    /* Executes the interpreted version of the Change Key command, as defined in 
     * the Mifare DESFire API. Response only includes the Status Code returned by 
     * the card. @param keyNum the key number within the selected card application
     * that we want to modify @param newKey an instance of class <code>DFKey</code> 
     * containing the new data about the key identified by <code>keyNum</code>
     * @param oldKey an instance of class <code>DFKey</code> containing the old data 
     * about the key identified by <code>keyNum</code> @return an instance of class 
     * <code>DFResponse</code> containing the response obtained from the Mifare 
     * DESFire card to the transmitted command */
    ...
    /* Executes the raw version of the Change Key command, as defined in the Mifare 
     * DESFire API. @param keyNum a byte array representing the key number within 
     * the selected card application with which we want to authenticate
     * @param encKeyData a byte array containing the new key, transformed for security 
     * as required @return a byte array representing the response obtained from the 
     * Mifare DESFire card to the transmitted command */
    ...
    /* Executes the interpreted version of the Get Key Version command, as defined 
     * in the Mifare DESFire API. Response includes an object of class 
     * <code>KeyVersion</code>, which can be retrieved with its method
     * <code>getKeyVersion()</code> @param keyNum the key number within the selected 
     * card application of which we want to retrieve its current version @return an 
    ...
    /* Executes the raw version of the Get Key Version command, as defined in the 
     * Mifare DESFire API. @param keyNum a byte array representing the key number 
     * within the selected card application of which we want to retrieve its current 
     * version @return a byte array representing the response obtained from the 
     * Mifare DESFire card to the transmitted command */
    ...
    /* Executes the interpreted version of the Create Application command, as defined in 
     * the Mifare DESFire API. Response only includes the Status Code returned by the card.
     * @param aid an instance of class <code>AID</code> representing the application 
     * identifier of the new application to be created in the card @param ks an 
     * instance of class <code>KeySettings</code> representing the desired key settings 
     * of the new application to be created @param numOfKeys the number of keys of 
     * the new application to be created @return an instance of class <code>DFResponse</code> 
     * containing the response obtained from the Mifare DESFire card to the transmitted command */
    ...
    /* Executes the interpreted version of the Create Application command, as defined 
     * in the Mifare DESFire EV1 API. Response only includes the Status Code returned 
     * by the card. @param aid an instance of class <code>AID</code> representing the
     * application identifier of the new application to be created in the card
     * @param ks an instance of class <code>KeySettings</code> representing the desired 
     * key settings of the new application to be created @param numOfKeys the number 
     * of keys of the new application to be created @param ISOFidAllow a boolean 
     * indicating whether ISO file identifiers are allowed or not in the new application
     ...
     * @param name an instance of class <code>DFName</code> representing the DF name 
     * of the new application to be created in the card @return an instance of class 
     * <code>DFResponse</code> containing the response obtained from the Mifare DESFire 
     * card to the transmitted command */
    public DFResponse createApplication(AID aid, KeySettings ks, int numOfKeys, 
    ...
    /* Executes the raw version of the Create Application command, as defined in the 
     * Mifare DESFire API. @param aid a byte array representing the application 
     * identifier of the new application to be created in the card @param keySettings 
     * a byte array representing the desired key settings of the new application 
     * to be created @param numOfKeys a byte array representing the number of keys of 
     * the new application to be created @return a byte array representing the 
     * response obtained from the Mifare DESFire card to the transmitted command */
    ...
    /* Executes the raw version of the Create Application command, as defined in 
     * the Mifare DESFire EV1 API. @param aid a byte array representing the
     * application identifier of the new application to be created in the card
     * @param ks a byte array representing the desired key settings of the new 
     * application to be created @param ks2 a byte array representing the number 
     * of keys of the new application to be created, as well as whether ISO file 
     * identifiers are allowed or not in the new application and the criptographic 
     * algorithm to be used @param fid a byte array representing the ISO file identifier 
     * of the new application to be created in the card @param name a byte array 
     * representing the DF name of the new application to be created in the card
     * @return a byte array representing the response obtained from the Mifare 
     * DESFire card to the transmitted command */
    ...
    /* Executes the interpreted version of the Delete Application command, as defined 
     * in the Mifare DESFire API. Response only includes the Status Code returned by 
     * the card. @param aid an instance of class <code>AID</code> representing the
     * application identifier of the new application to be created in the card
     * @return an instance of class <code>DFResponse</code> containing the response 
     * obtained from the Mifare DESFire card to the transmitted command */
    ...
    /* Executes the raw version of the Delete Application command, as defined in 
     * the Mifare DESFire API. @param aid a byte array representing the application 
     * identifier of the new application to be created in the card @return a byte 
     ...
     * as defined in the Mifare DESFire API. Response includes an object of class 
     * <code>AIDS</code>, which can be retrieved with its method <code>getAIDs()</code>.
     * @return an instance of class <code>DFResponse</code> containing the response 
     * obtained from the Mifare DESFire card to the transmitted command */
    ...
    /* Executes the raw version of the Get Application IDs command, as defined in 
    ...
    /* Executes the interpreted version of the Free Memory command, as defined in 
     * the Mifare DESFire EV1 API. Response includes an object of class <code>Size</code>, 
     * which can be retrieved with its method <code>getFreeMemory()</code>.
     * @return an instance of class <code>DFResponse</code> containing the response 
     * obtained from the Mifare DESFire card to the transmitted command */
    ...
    /* Executes the raw version of the Free Memory command, as defined in the Mifare 
     * DESFire EV1 API. @return a byte array representing the response obtained
     * from the Mifare DESFire card to the transmitted command */
    ...
    /* Executes the interpreted version of the Free Memory command, as defined in 
     * the Mifare DESFire EV1 API. Response includes an object of class 
     * <code>DFNamesRes</code>, which can be retrieved with its method 
     * <code>getDFNames()</code>. @return an instance of class <code>DFResponse</code> 
     * containing the response obtained from the Mifare DESFire card to the 
     * transmitted command */
    ...
    /* Executes the interpreted version of the Get Key Settings command, as defined 
     * in the Mifare DESFire API. Response includes an object of class 
     * <code>KeySettingsRes</code>, which contains an instance of <code>KeySettings</code> 
     * that can be retrieved with its method <code>getKeySettings()</code>, and 
     * the number of keys that can be obtained with its method <code>getNumOfKeys()</code>.
     * @return an instance of class <code>DFResponse</code> containing the response 
     * obtained from the Mifare DESFire card to the transmitted command */
    ...
    /* Executes the raw version of the Get Key Settings command, as defined in the 
     * Mifare DESFire API. @return a byte array representing the response obtained
     * from the Mifare DESFire card to the transmitted command */
    ...
    /* Executes the interpreted version of the Select Application command, as defined 
     * in the Mifare DESFire API. Response only includes the Status Code returned 
     * by the card. @param aid an instance of class <code>AID</code> representing the
     * application identifier of the application to be selected @return an instance 
    ...
    /* Executes the raw version of the Select Application command, as defined in 
     * the Mifare DESFire API. @param aid a byte array representing the application 
     * identifier of the application to be created in the card @return a byte array 
    ...
    /* Executes the interpreted version of the Format PICC command, as defined in 
     * the Mifare DESFire API. Response only includes the Status Code returned by 
    ...
    /* Executes the raw version of the Format PICC command, as defined in the Mifare 
     * DESFire API. @return a byte array representing the response obtained
     * from the Mifare DESFire card to the transmitted command */
    ...
    /* Executes the interpreted version of the Get Version command, as defined in 
     * the Mifare DESFire API. Response includes an object of class <code>PICCVersion</code>,
     * which can be retrieved with its method <code>getPICCVersion()</code>. The 
     * card UID can be retrieved directly with the method <code>getUID()</code>. 
     * @return an instance of class <code>DFResponse</code> containing the response 
     * obtained from the Mifare DESFire card to the transmitted command */
    ...
    /* Executes the raw version of the Get Version command, as defined in the Mifare 
     * DESFire API. @return a byte array representing the response obtained from 
     * the Mifare DESFire card to the transmitted command */
    ...
    /* Executes the interpreted version of the Get Card UID command, as defined in 
     * the Mifare DESFire EV1 API. Response includes an object of class <code>UIDRes</code>, 
     * which can be retrieved with its method <code>getUIDRes()</code>. The card 
     * UID can be retrieved directly with the method <code>getUID()</code>.
     * @return an instance of class <code>DFResponse</code> containing the response 
     * obtained from the Mifare DESFire card to the transmitted command */
    ...
    /* Executes the raw version of the Get Card UID command, as defined in the Mifare 
     * DESFire EV1 API. @return a byte array representing the response obtained
     * from the Mifare DESFire card to the transmitted command */
