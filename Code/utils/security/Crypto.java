...
public class Crypto {
    /* Encodes <code>data</code> @param data a byte array @param keyData a byte 
     * array containing the value of the key to use for encoding @param chain an 
     * instance of class <code>ChainMode</code> indicating how the differenc 
     * cryptographic blocks should be chained @param alg an instance of class 
     * <code>CipAlg</code> indicating the cryptographic algorithm to use in the 
     * encoding @return the encoded version of <code>data</code> */
    ...
    /* Encodes <code>data</code> @param data a byte array @param keyData a byte 
     * array containing the value of the key to use for encoding @param iv a byte 
     * array containing the initial vector to use in the encoding operation
     * @param chain an instance of class <code>ChainMode</code> indicating
     * how the differenc cryptographic blocks should be chained @param alg an 
     * instance of class <code>CipAlg</code> indicating the cryptographic algorithm 
     * to use in the encoding @param pad an instance of class <code>PaddingMode</code> 
     * indicating how blocks should be padded if needed @return the encoded version 
     * of <code>data</code> */
    public static byte[] encode(byte[] data, byte[] keyData, 
