...
import arin.desfirelib.utils.ba.DigitUtils.*;
...
public class BAUtils {
     ...
     * string <code>s</code> @param s the string to be converted @return a byte 
     * array representing the string <code>s</code> */
