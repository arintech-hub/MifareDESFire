...
public class KeySettings {
     ...
     * application configuration is changeable or not @param freeCreateDelete a 
     * boolean indicating whether applications or files can be created and/or 
     * deleted without previous authentication @param freeDirectoryListAccess a 
     * boolean indicating whether application or file identifiers can be listed
     * without previous authentication @param allowChangingMasterKey a boolean 
     * indicating whether the card or application master key can be modified */
    public KeySettings(int changeKeyAccessRights, boolean configurationChangeable, 
            boolean freeCreateDelete, boolean freeDirectoryListAccess,
     ...
     * without previous authentication @param allowChangingMasterKey a boolean
     * indicating whether the card or application master key can be modified */
    public KeySettings(boolean configurationChangeable, boolean freeCreateDelete, 
    		boolean freeDirectoryListAccess, boolean allowChangingMasterKey){
    	setChangeKeyAccessRights(0);
    	setConfigurationChangeable(true);
        setFreeCreateDelete(true);
        setFreeDirectoryListAccess(true);
    ...
    /* @return an int indicating the key to authenticate with to obtain permission 
     * to subsequent change keys operations */
    ...
    /* @return <code>true</code> if applications or files can be created and/or deleted
     * without previous authentication; <code>false</code> otherwise */
     ...
     * listed without previous authentication; <code>false</code> otherwise */
