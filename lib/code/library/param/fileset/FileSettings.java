...
public class FileSettings {
    ...
    /* Creates an instance of class <code>FileSettings</code> @param fileType an 
     * instance of class <code>FileType</code> representing the type of the current 
     * file @param comSet an instance of class <code>ComSet</code> representing 
    ...
    /* Creates an instance of class <code>FileSettings</code> @param fileType a
     * byte array representing the type of the current file @param comSet a byte 
     * array representing the file's communication settings @param accessRights a 
     * byte array representing the file's access rights */
    ...
    // @param fileType a int representing the new type of the current file
    public void setFileType(int fileType){
	this.fileType = FileType.toFileType(fileType);
    }

    // @param fileType a byte array representing the new type of the current file
    ...
    // @param comSet an int representing the file's new communication settings
    public void setComSet(int comSet){
	this.comSet = ComSet.toComSet(comSet);
    }
	
    // @param comSet a byte array representing the file's new communication settings
    ...
    // @param accessRights a byte array representing the file's new access rights
