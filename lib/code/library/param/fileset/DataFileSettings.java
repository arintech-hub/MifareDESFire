...
import arin.desfirelib.library.param.Size;
...
public class DataFileSettings extends FileSettings{
     ...
     * @param fileType an instance of class <code>FileType</code> representing the 
     * type of the file */
    public DataFileSettings(FileType fileType){
	this(fileType, ComSet.PLAIN, new AccessRights(), new Size(0));
    }
	
    /* Creates an instance of class <code>DataFileSettings</code> @param size an 
     * instance of class <code>Size</code> representing the size of the file */
    public DataFileSettings(Size size){
	this(FileType.STANDARD_DATA, ComSet.PLAIN, new AccessRights(), size);
    }
		
    /* Creates an instance of class <code>DataFileSettings</code> @param fileType
     * an instance of class <code>FileType</code> representing the type of the file
     ...
     * @param size fileSize an instance of class <code>Size</code> representing the 
     * size of the file */
    ...
    /* Creates an instance of class <code>DataFileSettings</code> @param fileSet 
    ...
    // @param size a byte array representing the current size of the file
