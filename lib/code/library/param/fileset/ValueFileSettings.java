...
public class ValueFileSettings extends FileSettings {
     ...
     * the file's communication settings @param accessRights an instance of class 
     * <code>AccessRights</code> representing the file's access rights */
     ...
     * the lower possible integer that can be stored in the file @param upperLimit
     * an instance of class <code>Value</code> representing the higher possible 
     * integer that can be stored in the file @param limitedCreditValue an instance
     * of class <code>Value</code> representing the maximum possible amount that 
     * can be increased via a call to <code>limitedCredit</code> @param 
     * limitedCreditEnabled a boolean indicating whether limited credit operations
     * are allowed or not */
    public ValueFileSettings(ComSet comSet, AccessRights accessRights,
    ...
    /* Creates an instance of class <code>ValueFileSettings</code> @param comSet 
     * an instance of class <code>ComSet</code> representing the file's communication
     * settings @param accessRights an instance of class <code>AccessRights</code> 
     * representing the file's access rights @param lowerLimit an instance of class
     * <code>Value</code> representing the lower possible integer that can be stored 
     * in the file @param upperLimit an instance of class <code>Value</code> 
     * representing the higher possible integer that can be stored in the file
     * @param limitedCreditValue an instance of class <code>Value</code>
     * representing the maximum possible amount that can be increased via a call 
     * to <code>limitedCredit</code> @param limitedCreditEnabled a boolean indicating 
     * whether limited credit operations are allowed or not @param getFreeValueEnabled
     * a boolean indicating whether get value operations are allowed without previous 
     * authentication */
    public ValueFileSettings(ComSet comSet, AccessRights accessRights,
            Value lowerLimit, Value upperLimit, Value limitedCreditValue, 
    ...
    /* Creates an instance of class <code>ValueFileSettings</code> @param fileSet 
     * a byte array containing the file settings */
    ...
    /* @return an instance of class <code>Value</code> representing the maximum 
     * possible value that can be increased via a call to <code>limitedCredit</code> */
    ...
    /* @return <code>true</code> if get value operations are allowed without 
     * previous authentication; <code>false</code> otherwise */
    public boolean getFreeValueEnabled(){
	return this.getFreeValueEnabled;
    }
	
    /* @param lowerLimit a byte array representing the lower possible integer that 
    ...
    /* @param lowerLimit an instance of class <code>Value</code> representing the 
     * lower possible integer that can be stored in the file */
    ...
    /* @param upperLimit a byte array representing the higher possible integer that 
     * can be stored in the file */
    ...
    /* @param upperLimit an instance of class <code>Value</code> representing the 
     * higher possible integer that can be stored in the file */
    ...
    /* Sets both the lower and upper limits of the value file @param lowerLimit
     * a byte array representing the lower possible integer that can be 
     * stored in the file @param upperLimit a byte array representing the higher
     * possible integer that can be stored in the file */
    ...
    /* Sets both the lower and upper limits of the value file @param lowerLimit 
     * an instance of class <code>Value</code> representing the lower possible 
     * integer that can be stored in the file @param upperLimit an instance of 
     * class <code>Value</code> representing the higher possible integer that can
    ...
    /* @param value a byte array representing the maximum possible amount that can 
     * be increased via a call to <code>limitedCredit</code> */
    ...
    /* @param value an instance of class <code>Value</code> representing the 
     * maximum possible amount that can be increased via a call to
     * <code>limitedCredit</code> */
    public void setLimitedCreditValue(Value value){
	this.limitedCreditValue = value;
    }
	
    /* @param enabled a byte array representing whether limited credit operations
     * are allowed or not */
    ...
    /* @param enabled a boolean indicating whether limited credit operations are 
     * allowed or not */
    ...
    /* Sets both the amount and permission corresponding to the limited credit
     * operations @param value a byte array representing the maximum possible 
     * amount that can be increased via a call to <code>limitedCredit</code>
     * @param enabled a byte array indicating whether get value operations are 
     * allowed without previous authentication */
    ...
    /* Sets both the amount and permission corresponding to the limited credit 
     * operations @param value an instance of class <code>Value</code> representing
     * the maximum possible amount that can be increased via a call to 
     * <code>limitedCredit</code> @param enabled a boolean indicating whether get 
     * value operations are allowed without previous authentication */
    ...
    /* @param limCredEnGetFreeValEn a byte array containing both the limited credit
     * and the free get value permissions */	 
    ...
    /* @param enabled a boolean indicating whether get value operations are allowed 
	...
	if(getFreeValueEnabled) 
            limitedCreditEnabledBA = BAUtils.xor(limitedCreditEnabledBA, BAUtils.toBA("02"));
