...
public class AccessRights {
    ...
    /* Creates an instance of class <code>AccessRights</code> @param readAccess
     * an int indicating the read access right @param writeAccess an int indicating 
     * the write access right @param readWriteAccess an int indicating the read & 
     * write access right @param changeAccessRights an int indicating the access right
