...
public enum SC {
    ...
    /* Indicates whether the Status Code corresponds to an <code>OPERATION_OK</code>
     * @return <code>true</code> if the Status Code is <code>OPERATION_OK</code>; 
     * <code>false</code>otherwise */
    public boolean isOk(){
	return (this == SC.OPERATION_OK);
    }
		
    /* Indicates whether the Status Code of the received response corresponds to 
     * an <code>OPERATION_OK</code> @param res a byte array containing the response
     * obtained from the card @return <code>true</code> if the Status Code is 
    ...
    /* Indicates whether the Status Code of the received response corresponds to 
     * an <code>ADDITIONAL_FRAME</code> @param res a byte array containing the response 
     * obtained from the card @return <code>true</code> if the Status Code is 
    ...
    /* Indicates whether the Status Code of the received response corresponds to 
     * successful ISO select operation @param res a byte array containing the response 
     * obtained from the card @return <code>true</code> if the operation has been 
     ...
     * @param sc a byte array containing the obtained Status Code from the card 
    ...
    /* Obtains the singleton object corresponding to the given Status Code
     * @param sc an int representing the obtained Status Code from the card 
     * @return an instance of class <code>SC</code> representing the Status Code */
