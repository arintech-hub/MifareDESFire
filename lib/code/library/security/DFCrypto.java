...
import arin.desfirelib.library.*;
...
public class DFCrypto {
    /* Generates the random frame RndA for the authentication operation of the 
     * suitable length according to the cryptographic algorithm in use
     * @param alg an instance of class <code>CipAlg</code> representing the current 
     * cryptographic algorithm @return a randomized byte array */
    ...
    /* Retrieves the RndB frame from the received enciphered array in the authentication 
     * operation @param ekRndB a byte array representing the received enciphered 
     * array containing the randomized RndB frame @param keyData a byte array representing 
     * the key by which the received frame has been enciphered @param alg an instance 
     * of class <code>CipAlg</code> representing the current cryptographic algorithm
     ...
     * including both the created RndA and the retrieved RndB @param RndA a byte 
     * array containing the created randomized RndA @param RndB a byte array 
     * containing the retrieved RndB @param keyData a byte array representing the 
     * key by which the received frame has been enciphered @param alg an instance 
     * of class <code>CipAlg</code> representing the current cryptographic algorithm
     ...
     * array containing the created randomized RndA @param RndB a byte array 
     * containing the retrieved RndB @param keyData a byte array representing the 
     * key by which the received frame has been enciphered @param iv a byte array 
     * representing the initial vector for the cryptographic operations
     * @param alg an instance of class <code>CipAlg</code> representing the current 
     * cryptographic algorithm @return an enciphered byte array generated using 
     * both RndA and RndB */
    ...
    /* Checks if the card has successfully retrieved the previously sent RndA frame
     * @param RndA a byte array containing the created randomized RndA
     * @param ekRndAp a byte array containing the retrieved RndAp @param keyData 
     * a byte array representing the key by which the received frame has been enciphered
     * @param alg an instance of class <code>CipAlg</code> representing the current 
     * cryptographic algorithm @return <code>true</code> true if the PICC has been 
     ...
     * @param ekRndAp a byte array containing the retrieved RndAp @param keyData 
     * a byte array representing the key by which the received frame has been enciphered
     * @param iv a byte array representing the initial vector for the cryptographic 
     * operations @param alg an instance of class <code>CipAlg</code> representing
     * the current cryptographic algorithm @return <code>true</code> true if the 
     * PICC has been successfully authenticated; <code>false</code> otherwise */
    public static boolean getPICCAuth(byte[] RndA, byte[] ekRndAp, 
            byte[] keyData, byte[] iv, CipAlg alg){
    ...
    /* Generates the current session key @param RndA a byte array containing the 
     * created randomized RndA @param RndB a byte array containing the retrieved RndB
     * @param alg an instance of class <code>CipAlg</code> representing the current 
     * cryptographic algorithm @return a byte array representing the current session key */
    ...
    /* Generates the byte array representation of a key number, in the suitable 
     * format according to the cryptographic algorithm in use @param keyNum an int 
     * indicating the key number @param alg an instance of class <code>CipAlg</code> 
     * representing the current cryptographic algorithm @return a byte array 
     * representing the key number given by <code>keyNum</code> */
    ...
    /* Extracts the field bytes from a response frame @param res a byte array received 
     * from a card, without the status code @param session an instance of class 
    ...
    /* Generates the byte array corresponding to the Key Settings 2 structure   
     * @param numOfKeys an int representing the number of keys @param ISOFidAllow 
     * a boolean indicating whether ISO file identifiers are allowed @param alg an 
     * instance of class <code>CipAlg</code> representing the current cryptographic 
     * algorithm @return a byte array representing the Key Settings 2 structure */
     ...
     * command @param opt an instance of class <code>ConfigOption</code> representing
     * the configuration options @param session an instance of class 
     * <code>DFSession</code> representing the current communication session
     * @return a byte array representing the <code>setConfiguration</code> send parameter */
    ...
    /* Generates the byte array to send data @param fid an instance of class 
     * <code>FID</code> representing the file identifier @param offset an instance 
     * of class <code>Size</code> representing the starting point of the data bytes 
     * in the frame @param data an instance of class <code>Data</code> containing the
     * data bytes to send @param comSet an instance of class <code>ComSet</code> 
     * representing the current communication settings @param ar an instance of 
     * class <code>AccessRights</code> representing the current access rights
     * @param com an instance of class <code>ComCode</code> representing the command 
     * code @param session an instance of class <code>DFSession</code> representing
     * the current communication session @return a byte array with the data to be 
     * sent suitably formatted */
    ...
    /* Obtains the communication settings that will effectively be used when sending 
     * data @param comSet an instance of class <code>ComSet</code> representing
     * the current communication settings @param ar an instance of class 
     * <code>AccessRights</code> representing the current access rights @param session 
     * an instance of class <code>DFSession</code> representing the current communication 
     * session @return an instance of class <code>ComSet</code> representing the
    ...
    /* Extracts the effective data bytes from a response frame @param res a byte 
     * array received from a card, without the status code @param length an instance 
     * of class <code>Size</code> representing the number of bytes that have been 
     * read from the card @param comSet an instance of class <code>ComSet</code> 
     * representing the current communication settings @param ar an instance of 
     * class <code>AccessRights</code> representing the current access rights
     * @param session an instance of class <code>DFSession</code> representing
     * the current communication session @return a byte array corresponding to the 
     ...
     * array received from a card, without the status code @param length an instance 
     * of class <code>Size</code> representing the number of bytes that have been 
     * read from the card @param effComSet an instance of class <code>ComSet</code> 
     * representing the effective communication settings @param session an instance 
     ...
     * effective read data response structure */
    private static DataRes getDataRes(byte[] res, Size length, ComSet effComSet, 
            DFSession session){
    ...
    /* Obtains the communication settings that will effectively be used when reading data
     * @param comSet an instance of class <code>ComSet</code> representing the current 
     * communication settings @param ar an instance of class <code>AccessRights</code> 
     * representing the current access rights @param session an instance of class 
     * <code>DFSession</code> representing the current communication session
    ...
    /* Extracts the bytes corresponding to the Cyclic Redundancy Code from a received 
     * frame @param plainRes a byte array received from a card, without the status 
     * code @return a byte array corresponding to the CRC extracted from
     * <code>plainRes</code> */
    ...
    /* Obtains the position where the Cyclic Redundancy Code of a received frame ends
    ...
    /* Extracts the effective value bytes from a response frame @param res a byte 
     * array received from a card, without the status code @param comSet an instance 
     * of class <code>ComSet</code> representing the current communication settings
     * @param ar an instance of class <code>AccessRights</code> representing
     * the current access rights @param getFreeValue a boolean indicating whether 
     * get value operations are allowed without previous authentication
     * @param session an instance of class <code>DFSession</code> representing
     * the current communication session @return a byte array corresponding to the 
    ...
    /* Extracts the effective value bytes from a response frame @param res a byte 
     * array received from a card, without the status code @param effComSet an 
     * instance of class <code>ComSet</code> representing the effective communication 
     * settings @param session an instance of class <code>DFSession</code> representing
     * the current communication session @return an instance of class <code>ValueRes</code> 
     * corresponding to the effective get value response structure */
    ...
    /* Obtains the communication settings that will effectively be used when reading 
     * a value @param comSet an instance of class <code>ComSet</code> representing
     * the current communication settings @param ar an instance of class 
     * <code>AccessRights</code> representing the current access rights @param getFreeValue
     * @param session an instance of class <code>DFSession</code> representing 
     * the current communication session @return an instance of class <code>ComSet</code> 
     * representing the effective communication settings */
    ...
    /* Generates the byte array to send a value @param value an instance of class 
     * <code>Value</code> representing the amount to send @param comSet an instance 
     * of class <code>ComSet</code> representing the current communication settings
     * @param ar an instance of class <code>AccessRights</code> representing
     * the current access rights @param com an instance of class <code>ComCode</code> 
     * representing the command code @param session an instance of class <code>DFSession</code> 
     * representing the current communication session @return a byte array with the 
     * data to be sent suitably formatted */
     ...
     * a value @param comSet an instance of class <code>ComSet</code> representing
     * the current communication settings @param ar an instance of class 
     * <code>AccessRights</code> representing the current access rights @param com 
     * an instance of class <code>ComCode</code> representing the command code
     * @param session an instance of class <code>DFSession</code> representing
     * the current communication session @return an instance of class <code>ComSet</code> 
     * representing the effective communication settings */
    ...
    /* Extracts the effective record bytes from a response frame @param res a byte 
     * array received from a card, without the status code @param length an instance 
     * of class <code>Size</code> representing the number of records that have been 
     * read from the card @param recSize an instance of class <code>Size</code> 
     * representing the length of each record @param comSet an instance of class 
     * <code>ComSet</code> representing the current communication settings @param ar 
     * an instance of class <code>AccessRights</code> representing the current access 
     * rights @param session an instance of class <code>DFSession</code> representing
     * the current communication session @return an instance of class <code>RecordsRes</code> 
     * corresponding to the effective read records response structure */
